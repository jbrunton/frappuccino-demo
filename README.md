...
* **Platform-agnostic, framework-agnostic and testable**: Frappuccino leverages a dependency injection container to facilitate the reuse of classes across multiple platforms (e.g. client, server, mobile apps), with different frameworks (e.g. Knockout.js, Backbone.js, Node.js or Appcelerator Titanium), and also for testing purposes.
